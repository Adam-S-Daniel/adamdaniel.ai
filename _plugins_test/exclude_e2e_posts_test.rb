...
#
# Unit tests for _plugins/exclude_e2e_posts.rb. Run with:
#
#   bundle exec ruby _plugins_test/exclude_e2e_posts_test.rb
#
# Kept outside _plugins/ so Jekyll doesn't auto-load this at build time.
...
# site Gemfile (matches the other _plugins_test/ files).

require_relative '../_plugins/exclude_e2e_posts'
