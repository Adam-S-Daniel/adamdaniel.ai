...
- `.agents/skills/embeddable-tool-pages/` — add a self-contained interactive tool to the `/tools/` section (static-asset + iframe pattern, collection + Decap wiring) or embed one in a post
